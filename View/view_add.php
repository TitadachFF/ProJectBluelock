                ...
                <div class="card p-3 border" style="background-image: url('../data/images/BG-D.png');">
                    ...
                    <div class="d-flex">
                        ...
                        <br>
                            <form name="frmadd" method="post" action="view_success-add.php" enctype="multipart/form-data">              
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="first_name" class="form-control" id="first_name" placeholder="first_name" required>
                                    </div>
                                </div>
                            <br>
                                <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input list="team" name="team" class="form-control" placeholder="team" required>
                                    <datalist id="team">
                            ...
                            <br>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input list="position" name="position" class="form-control" placeholder="position" required>
                        ...
                        <center>
                            ...
                            <img class="card-img-top" src="https://media1.tenor.com/images/a9ff550f8085a7266923b4e8a79a3e73/tenor.gif?itemid=13469811" alt="..." />
